...
This repository contains Java projects developed during the **Software Development Internship**. The projects are categorized into **Major Project** (fully refactored with OOPs, Concurrency, and Exception Handling) and **Minor Projects** (core utility and game apps).
